...
public class RangeSearchVisualizer {
    ...
    public static void main(String[] args) {
    	...
    	String filename = "C:\\Users\\minhsiang0617\\Desktop\\Algorithm\\kd tree\\kdtree\\input.txt";
		...
		double x0 = 0.1875, y0 = 0.3125; // initial endpoint of rectangle
		double x1 = 0.4375, y1 = 0.75; // current location of mouse
